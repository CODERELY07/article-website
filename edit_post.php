...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-300 antialiased">
    <div class="max-w-3xl mx-auto p-6">
        ...
        <a href="post.php?id=<?php echo $postId; ?>" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4">Back to Post</a>
        ...
        <form method="POST" id="postForm" enctype="multipart/form-data" class="space-y-4">
            <div>
                <label for="banner" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Banner Image (optional)</label>
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($post['title']); ?>" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div>
                <label for="content" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Content</label>
                <div id="editor" class="bg-white dark:bg-gray-800 rounded-b-md"><?php echo $post['content']; ?></div>
                <input type="hidden" name="content" id="content" value="<?php echo htmlspecialchars($post['content']); ?>">
            </div>
            <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Update Post</button>
        </form>
    </div>
